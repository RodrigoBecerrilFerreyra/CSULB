...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_dec.vdi -applog -m64 -messageDb vivado.pb -mode batch -source enc_dec.tcl -notrace
