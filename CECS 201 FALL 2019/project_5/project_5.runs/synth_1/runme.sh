...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_dec.vds -m64 -mode batch -messageDb vivado.pb -notrace -source enc_dec.tcl
