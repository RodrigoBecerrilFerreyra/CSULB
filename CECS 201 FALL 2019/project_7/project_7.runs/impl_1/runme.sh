...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_7/project_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_counter_32bit.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_counter_32bit.tcl -notrace
