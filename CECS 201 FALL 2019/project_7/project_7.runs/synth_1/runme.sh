...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_counter_32bit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_counter_32bit.tcl
