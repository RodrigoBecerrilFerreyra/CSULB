...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_2to1_case_tb.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mux_2to1_case_tb.tcl
