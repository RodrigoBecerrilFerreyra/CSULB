...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_2to1_case_tb.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mux_2to1_case_tb.tcl -notrace
