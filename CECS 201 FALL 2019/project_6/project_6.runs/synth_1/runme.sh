...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_6/project_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source four_bit_adder.tcl
