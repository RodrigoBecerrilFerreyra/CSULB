...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_6/project_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_adder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source four_bit_adder.tcl -notrace
