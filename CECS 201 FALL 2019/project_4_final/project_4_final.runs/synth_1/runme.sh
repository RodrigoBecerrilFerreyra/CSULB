...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_4_final/project_4_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4to1_case.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mux_4to1_case.tcl
