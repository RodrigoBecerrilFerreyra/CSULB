...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_8/project_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fsm_top.tcl -notrace
