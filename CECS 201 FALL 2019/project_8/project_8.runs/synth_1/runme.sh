...
HD_PWD='E:/Coding Projects/CECS 201 FALL 2019/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fsm_top.tcl
