...
HD_PWD='C:/Users/oscar/Coding Projects/CSULB/CECS 301 SPRING 2020/Project 3/Project 3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log posedge_check_output.vdi -applog -m64 -messageDb vivado.pb -mode batch -source posedge_check_output.tcl -notrace
