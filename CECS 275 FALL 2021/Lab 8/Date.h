...
class Date
{
    ...
    public:
        ...
        */
         ...
         * @return Whether or not the date inputted is valid.
         */
        static bool isValid(int day_, int month_, int year_);
         ...
         * date. If the input is an invalid date, the value is not saved into
         * the object. The data is expected in the following order:
         * is >> day >> month >> year;
