...
* their status as an inpatient or an outpatient.
* CECS 275 - Fall 2021
* @author Ethan Hua
...
int patientType(){
    ...
    cout << "Input the admission type now: ";
...
double configuration(int patientData){
    ...
    if(patientData == 0){ // inpatient case
        ...
        if(duration == 1){ // specific formatting for only 1 day
            cout << "Patient was admitted for " << duration 
            << "day." << endl;
        }
        ...
        cout << "Daily Rate...............: $" << setprecision(2) <<
        fixed << hospitalFee << endl;
        cout << "    Daily Total..........: $" << setprecision(2) <<
        fixed << dailyCharges << endl;
        cout << "Medication Fees..........: $" << setprecision(2) <<
        fixed << medicalFee << endl;
        cout << "Services Fees............: $" << setprecision(2) << 
        fixed << servicesFee << endl;

        cout << endl;
        cout << "Final charges incurred...: $" << setprecision(2) 
        << fixed << finalCharges << endl;
